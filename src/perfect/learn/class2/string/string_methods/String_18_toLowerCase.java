...
public class String_18_toLowerCase {
 ...
 * is the write location in result
        ...
        There are two variant of toLowerCase() method. The signature or syntax
        of string toLowerCase() method is given below:
